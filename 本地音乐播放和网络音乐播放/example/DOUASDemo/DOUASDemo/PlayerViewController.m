...
+ (id)sharePlayer
{
    static PlayerViewController *onceVC = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        onceVC = [[PlayerViewController alloc] init];
    });
    return onceVC;
}
- (void)viewDidLoad
{
  ...
  _miscLabel = [[UILabel alloc] initWithFrame:CGRectMake(0.0, CGRectGetMaxY([_statusLabel frame]) + 10.0, CGRectGetWidth([self.view bounds]), 20.0)];
  ...
  [self.view addSubview:_miscLabel];
  ...
  [_buttonStop setFrame:CGRectMake(round((CGRectGetWidth([self.view bounds]) - 60.0) / 2.0), CGRectGetMaxY([_buttonNext frame]) + 20.0, 60.0, 20.0)];
  ...
  _progressSlider = [[UISlider alloc] initWithFrame:CGRectMake(20.0, CGRectGetMaxY([_buttonStop frame]) + 20.0, CGRectGetWidth([self.view bounds]) - 20.0 * 2.0, 40.0)];
  ...
  _volumeSlider = [[UISlider alloc] initWithFrame:CGRectMake(CGRectGetMaxX([_volumeLabel frame]) + 10.0, CGRectGetMinY([_volumeLabel frame]), CGRectGetWidth([self.view bounds]) - CGRectGetMaxX([_volumeLabel frame]) - 10.0 - 20.0, 40.0)];
